...
namespace TetrisProject
{
    ...
    public class ShapeI : Shape
    {
        ...
        {
            blocks[1].Position = new Point(3, 0);
            blocks[2].Position = new Point(4, 0);
            blocks[3].Position = new Point(5, 0);
            blocks[4].Position = new Point(6, 0);
